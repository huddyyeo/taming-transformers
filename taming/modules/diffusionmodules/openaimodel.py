...
from taming.modules.diffusionmodules.util import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
...
from taming.modules.attention import SpatialTransformer, LinearAttention
...
class UNetModel(nn.Module):
    ...
    def convert_to_fp16(self):
        ...
        """
        self.cond_conv.apply(convert_module_to_f16)
        self.input_conv.apply(convert_module_to_f16)
    ...
    def convert_to_fp32(self):
        ...
        """
        self.cond_conv.apply(convert_module_to_f32)
        self.input_conv.apply(convert_module_to_f32)
    ...
    def forward(self, x, timesteps=None, context=None, y=None,**kwargs):
        ...
        if isinstance(context, tuple):
            conditioning = context[0]
        elif isinstance(context,torch.Tensor):
            conditioning = context
        else:
            raise ValueError(f"Got context of type {type(context)}")
        hs = []
